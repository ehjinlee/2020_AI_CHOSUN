...
print(max(y_train))
temp_y = []
for one_y_val in y_train: #y_train(6만개 존재) 안에서 첫번째 꺼에 저장-> 두번째꺼에 저장 -> 세번째거에 저장...... 반복
    zero_array = np.zeros(10) #zero_array라는 공간을 만들고 10개의 0이 들어감 : zero_array = [0 0 0 0 0 0....]
    zero_array[one_y_val] = 1 #현재 위치에 1 이라는 설정 저장. ex)첫번째 반복일때 zero_array=[1 0 0 0 0 0...], 두번째 반복일때 zero_array=[0 1 0 0 0 0....]
